  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Image src="/reelms-logo.svg" alt="Reelms" width={34} height={34} style={{ objectFit: "contain" }} />
        </div>

        <div>
          <span style={{ fontFamily: "var(--font-karla), 'Karla', sans-serif", fontSize: "1.1rem", fontWeight: 800, color: "#ffffff", display: "block" }}>
            Reelms Ignite All
          </span>
          <span style={{ fontFamily: "var(--font-karla), 'Karla', sans-serif", fontSize: "0.76rem", color: "#ff8b60", fontWeight: 700 }}>
      ...
      {/* ── Balanced 4-Corner Floating Cards ── */}
      ...
      <motion.div
        ...
        style={{
          ...
          alignItems: "center",
          gap: "10px",
          boxShadow: "0 14px 32px rgba(0, 0, 0, 0.5), 0 0 18px rgba(255, 107, 74, 0.2)",
          cursor: "pointer",
        }}
      >
        <FlameIcon size={20} />
        <div style={{ display: "flex", flexDirection: "column" }}>
          <span style={{ fontFamily: "var(--font-karla), 'Karla', sans-serif", fontSize: "0.84rem", fontWeight: 800, color: "#ffffff" }}>
            4K 60FPS Cast
          </span>
          <span style={{ fontFamily: "var(--font-karla), 'Karla', sans-serif", fontSize: "0.68rem", color: "rgba(255, 255, 255, 0.6)" }}>
